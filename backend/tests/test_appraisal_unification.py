...
from backend.models.appraisal import Appraisal, Comparable, AppraisalLog
from backend.models.tasacion import Tasacion, TasacionComparable, TasacionLog
...
def test_migration_preserves_ids_and_tipo(app):
    with app.app_context():
        ...
        from backend.services.appraisal_service import AppraisalService
...
def test_dual_write_flag_respected(app):
    ...
    app.config['DUAL_WRITE_TASACIONES'] = False
    with app.app_context():
        from backend.services.tasacion_sync import TasacionSync
